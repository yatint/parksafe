    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[80] flex items-center justify-center px-5 bg-ink/40 backdrop-blur-md"
          onClick={onClose}
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-md bg-white border border-ink/10 rounded-2xl p-8 shadow-[0_30px_80px_-20px_rgba(19,31,56,0.35)]"
          ...
          >
            ...
            <div className="w-12 h-12 rounded-xl bg-ember/10 border border-ember/30 flex items-center justify-center">
              <QrCode className="w-6 h-6 text-ember" />
            </div>
            <h3 className="font-display text-2xl font-bold mt-5 text-ink">Activate your QR</h3>
            ...
            <form onSubmit={submit} className="mt-6">
              <input
                ...
                className="w-full bg-bone border border-ink/10 rounded-xl px-4 py-3.5 font-mono text-lg tracking-[0.4em] text-center text-ink placeholder:text-slate-400 focus:outline-none focus:border-ember/70 transition-colors"
              />
              <button
                type="submit"
            ...
            <p className="text-xs text-slate-400 mt-4 text-center font-mono tracking-wide">
